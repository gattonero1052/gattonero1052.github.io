...
/******/ 	return __webpack_require__(__webpack_require__.s = "./node_modules/workerize-loader/dist/rpc-worker-loader.js!./src/components/poker/algo.worker.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./node_modules/workerize-loader/dist/rpc-worker-loader.js!./src/components/poker/algo.worker.js":
/*!*******************************************************************************************************!*\
  !*** ./node_modules/workerize-loader/dist/rpc-worker-loader.js!./src/components/poker/algo.worker.js ***!
  \*******************************************************************************************************/
...
class Node {
    constructor(parent = null, turn = 0, player, computer, choice = null, level, choiceHistory) {
        ...
        this.choice = choice
        this.end = (!this.turn && !this.computerCards.length) || (this.turn && !this.playerCards.length) ?1:0
...
class Player {
    ...
    choices(choice = null) {
            ...
            if (consec.length > 4) {
                for (let j = 0; j < consec.length - 4; j++)
                    for (let k = j + 5; k <= consec.length; k++)
                        consecs.push(lodash__WEBPACK_IMPORTED_MODULE_0___default.a.slice(consec, j, k))
            }
        ...
        for (let i = 0; i < this.cards.length; i++) {
            ...
            let last = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.last(consec)
        ...
        for (let i = 0; i < threes.length; i++) {
            for (let j = 0; j < this.cards.length; j++) {
                if (this.cards[j] != threes[i][0]) {
                    threeOnes.push(lodash__WEBPACK_IMPORTED_MODULE_0___default.a.concat(threes[i], [this.cards[j]]))
                }
            }

            for (let j = 0; j < twos.length; j++) {
                if (twos[j][0] != threes[i][0]) {
                    threeTwos.push(lodash__WEBPACK_IMPORTED_MODULE_0___default.a.concat(threes[i], twos[j]))
                }
            }
        }
        ...
        return all.reduce((p, c) => lodash__WEBPACK_IMPORTED_MODULE_0___default.a.concat(p, lodash__WEBPACK_IMPORTED_MODULE_0___default.a.uniqBy(c, JSON.stringify)), [])
...
function build(player, computer, playerFirst ,MAXHEAP) {
...
/******/ });
//# sourceMappingURL=a30f563976dfedec257e.worker.js.map